...
import com.springboot.application.service.UserExcelExporter;
...
public class UsuarioController {
	...
	public void exportarExcel(HttpServletResponse response) throws IOException{
		...
		String headerValue = "attachment; filename=usuarios-"+ currentDateTime + ".xlsx";
		response.setHeader(headerKey, headerValue);
		
		List<Usuario> listaUsuario = userService.listAll();
		
		UserExcelExporter excelExporter = new UserExcelExporter(listaUsuario);
